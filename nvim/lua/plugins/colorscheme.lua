...
local function apply_terminal_colors()
  -- gruvbox-material.vim sets g:terminal_color_0..15 itself, but duplicates
  -- each bright variant onto its normal color. Match kitty's generated ANSI
  -- palette exactly for embedded :terminal buffers (sidekick, :terminal).
