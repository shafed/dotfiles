...
s({trig = "rrd", name = "Superscript", snippetType = "autosnippet", wordTrig = false},
    {
        t("^{"), d(1,get_visual), t("}")
    },
    {condition = in_mathzone}
...
s({trig = "rd", name = "Short superscript", snippetType = "autosnippet", wordTrig = false},
    {
        t("^")
    },
    {condition = in_mathzone}
...
s({trig = "lim", name = "Limits", snippetType = "autosnippet"},
    {
		f(function(_,snip) return snip.captures[1] end),
        t("\\limits")
    },
...
s({trig = "mx", name = "maximum", snippetType = "autosnippet", regTrig = true},
    {
		f(function(_,snip) return snip.captures[1] end),
		t("\\max")
    },
