  ...
  readonly property var sections: [
    ...
    },
    {
      ...
      entries: [
        ...
        { key: "Apps + U+I", action: "Volume down" },
        { key: "Apps + I+O", action: "Volume up" },
        { key: "Apps + O+P", action: "Mute output" },
        { key: "Apps + J+K", action: "Brightness down" },
        { key: "Apps + K+L", action: "Brightness up" },
        { key: "Apps + W+E", action: "Toggle system overview" }
      ]
    },
    {
      ...
      accent: "green",
      entries: [
        { key: "D + F", action: "Esc / hold Ctrl+Shift" },
