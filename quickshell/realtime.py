...
replace_once(
    ...
    "  readonly property int liveVolume: liveAudioSink && liveAudioSink.ready && liveAudioSink.audio\n"
    "                                    ? Math.round(liveAudioSink.audio.volume * 100)\n"
    "                                    : Number(state.audio ? state.audio.volume : 0)\n"
    "  readonly property bool liveMuted: liveAudioSink && liveAudioSink.ready && liveAudioSink.audio\n"
