...
export ahk="/mnt/c/Program Files/AutoHotkey/config.ahk"
export zsh=~/.zshrc
export glaze="$winuser/.glzr/glazewm/config.yaml"
export dots=~/dotfiles
export df=~/dotfiles
export downloads="$winuser/Downloads"
export ds="$winuser/Downloads"
